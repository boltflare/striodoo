...
class RestAPI:
	def __init__(self):
		self.url = 'https://stri-pruebasclasscode-1335886.dev.odoo.com'
		self.client_id = 'TXJEbcV9Vx2GV4zBrYuzdN2XN2P8qP'
		self.client_secret = '9qAvPa9biobBN4XLcqwOKqpKRswFrK'
