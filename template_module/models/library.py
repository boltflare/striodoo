...
class RestAPI:
	def __init__(self):
		self.url = 'https://stri-pruebasclasscode-1392453.dev.odoo.com'
		self.client_id = 'dbmE4kN7b0DS1dRD0F3PYvE1HkPrez'
		self.client_secret = 'stKloSqpSL3u5HgQhrQtdy8ICCdRaU'
