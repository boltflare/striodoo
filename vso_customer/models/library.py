...
class RestAPI:
	def __init__(self):
		self.url = 'https://stri-pruebasclasscode-1249989.dev.odoo.com'
		self.client_id = 'pahgUfYC2BUJ6TVeRVxzesp8Gvgs56'
		self.client_secret = 'h5LfTPkq2B9G7qk3S5Gzy4bDI6ZdeV'
