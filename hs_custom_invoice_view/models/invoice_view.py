...
class InvoiceView(models.Model):
	...
	hs_product_id = fields.Char(string='Item Code', related='invoice_line_ids.product_id', store=True) #debo cambiarlo que sea tipo char
	...
	def update_meal_card_view(self):
		...
		if self.invoice_line_ids:
			self.hs_product_id = self.invoice_line_ids.product_id
		if self.product_id:
